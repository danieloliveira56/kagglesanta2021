...
# get_optimal_solution(get_words(5), num_strings=3)
...
#
# better_string1 = local_search(num_letters=7, search_length=40, assume_shortening=2, initial_solution=string2, other_strings=[string1, string3])
#
# print(len(string1))
# print(string1)

# get_optimal_solution(get_words(7), num_strings=3, LB=2100, UB=2440, letter_spacing=3, tight_model=True)
